...
<html lang="en">
	...
	<head>
		...
		<title>Landing Page | Apotek</title>
        ...
        <style>
            ...
            #notification-popup {
                z-index: 50; /* Ensures the popup appears above other elements */
            }
        </style>
	</head>
	...
	<body>
		...
		<section class="flex items-center justify-between gap-5 wrapper">
			...
			<div class="flex items-center gap-[10px]">
                <button id="notification-button" type="button" class="p-2 bg-white rounded-full">
                    <span class="relative">
                        <!-- notification -->
            ...
            @forelse ($products as $product)
                <div id="notification-popup" class="hidden fixed top-12 right-0 mt-2 mr-2 w-64 bg-white shadow-lg rounded-lg p-4">
                    <h3 class="font-bold text-lg mb-2">Notifications</h3>
                    <ul class="flex items-center">
                        <img src="{{ Storage::url($product->photo) }}" class="h-[60px] w-[60px] object-contain mr-2 rounded" alt="">
		...
		<section class="wrapper flex flex-col gap-2.5 items-center justify-center">
			...
			<form action="{{ route('front.search') }}" method="GET" id="searchForm" class="w-full">
				<input style="background-image: url('{{asset('assets/svgs/ic-search.svg')}}')"
		...
		<section class="wrapper !px-0 flex flex-col gap-2.5">
			...
			<div id="proudctsSlider" class="relative">
                ...
                @empty
                    <p>
                        Belum ada produk baru yang tersedia
                    </p>
                @endforelse
			</div>
		</section>
