<x-app-layout>
    <x-slot name="header" >
        <div class="flex flex-row w-full justify-between items-center">
            ...
            <a href="{{ route('product_transactions.index') }}" class="font-bold py-3 px-6 rounded-full text-white bg-red-700">Back</a>
        </div>
    </x-slot>
            ...
            <div class="bg-white flex flex-col gap-y-5  overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <div class="item-card flex gap-y-3 flex-col md:flex-row justify-between md:items-center">
                    ...
                    @if ($productTransaction->is_paid)
                        <span class="py-2 px-4 w-fit rounded-full  bg-green-500">
                            <p class="text-white font-bold text-sm">
                                SUCCESS
                            </p>
                        </span>
                    @else
                        <span class="py-2 px-4 w-fit rounded-full  bg-orange-500">
                            <p class="text-white font-bold text-sm">
                                PENDING
                            </p>
                        </span>
